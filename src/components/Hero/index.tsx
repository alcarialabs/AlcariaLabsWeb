      ...
      <div className="container">
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4">
            ...
            >
              <MotionH1
                className="mb-5 text-3xl font-bold leading-tight text-[#01203F] dark:text-white sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight"
                initial={{ opacity: 0, y: -20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                En <strong>ALCARIA</strong> ofrecemos soluciones personalizadas
                de automatización y chatbots que optimizan tus procesos
                operativos. Descubre cómo podemos ayudarte a transformar
              ...
              >
                <Link
                  href="#contact"
                  className="rounded-sm bg-[#0344DC] px-8 py-4 text-base font-semibold text-white duration-300 ease-in-out hover:bg-[#0344DC]/80"
                >
      ...
      <div className="absolute right-0 top-0 z-[-1] opacity-30 lg:opacity-100">
        ...
        >
          ...
          <defs>
            ...
            >
              <stop stopColor="#0344DC" />
              <stop offset="1" stopColor="#0344DC" stopOpacity="0" />
            </linearGradient>
            <radialGradient
            ...
            >
              <stop offset="0.145833" stopColor="#0344DC" stopOpacity="0" />
              <stop offset="1" stopColor="#0344DC" stopOpacity="0.08" />
            </radialGradient>
            <radialGradient
        ...
        >
          ...
          <defs>
            <linearGradient
              ...
              gradientUnits="userSpaceOnUse"
            >
              <stop stopColor="#0344DC" stopOpacity="0" />
